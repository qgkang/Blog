...
?>
    您好，欢迎光临<?php echo $_SESSION['name']; ?>的博客！<a id='blogmain' onclick="javascript:open('manage.php','_parent','',false)">进入管理页面</a>&nbsp;<a onclick="javascript:open('logout.php','_parent','',false)">退出登录</a>&nbsp; 
    <?php	
	}else{
?>
...
?>
  ...
  <div id="nav"> 
    ...
    <div id="rightfloat">
        <a onclick='javascript:open("center.php?uid=<?php echo $_GET['uid'] ?>","_parent","",false)'>我的文章</a>
